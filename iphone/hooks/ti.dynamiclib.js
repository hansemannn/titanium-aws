...
exports.init = function (logger, config, cli, appc) {
	cli.on('build.ios.xcodeproject', {
		pre: function (data) {
			...
			var moduleVersion = '1.0.0'; // TODO: Get from tiapp.xml
			
			var scriptPath = '../../modules/iphone/ti.aws/' + moduleVersion + '/platform/AWSCore.framework/strip-frameworks.sh';
			var frameworkPaths = [
				'../../modules/iphone/ti.aws/' + moduleVersion + '/platform/AWSCore.framework'
			];
